...
- **Name:** `python-app-on-org`
- **Host:** `python-app-on-org.parcer.com`
- **Path:** `/app/`
- **Path Type:** Prefix
- **Backend Service:** `python-app-on-org:8080`
...
- **Internal:** `http://python-app-on-org:8080`
- **External:** `http://python-app-on-org.parcer.com/app/` (via Ingress)
...
The Helm chart is located in `charts/python-app-on-org/`:

```
charts/python-app-on-org/
...
- **Ingress Host:** `python-app-on-org.parcer.com`
- **Ingress Class:** nginx
- **Resources:**
  - CPU Request: 50m
  - Memory Request: 50M
...
```bash
# Install the chart
helm install python-app-on-org ./charts/python-app-on-org

# Install with custom values
helm install python-app-on-org ./charts/python-app-on-org -f custom-values.yaml

# Upgrade existing installation
helm upgrade python-app-on-org ./charts/python-app-on-org

# Uninstall
helm uninstall python-app-on-org
```
...
replicaCount: 3
image:
  repository: your-registry/python-app-on-org
  tag: latest
service:
  type: LoadBalancer
  port: 5000
...
- **Component Name:** python-app-on-org
- **Type:** service
- **Owner:** capes
